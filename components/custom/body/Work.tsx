    ...
    <>
      <section className="relative overflow-visible py-6">
        <div className="flex justify-between items-center my-6 px-6">
          <p className="text-lg dark:text-zinc-100 font-semibold">Work</p>
        </div>

        <div className="py-4 px-6">
          <div>
            <h3 className="font-semibold dark:text-zinc-300 text-lg text-zinc-700">
              RoadSense: Alternative Route Finder
            </h3>
            <p className="text-sm">Research</p>
            <p className="text-sm">Jan 2025 - Current</p>
          </div>
          <br />
          <p className={`${EbGaramond.className} text-xl py-2`}>
